...
const DetailRecipe = () => {
    ...
    //conditonal render
    let productTitle = <h1 className="text-center" style={{ "color": "#2E266F", "margin": "5vh 0vh 5vh 0vh" }}>{product.food_name}</h1>
    ...
    <div>
        <div className="container" data-aos="fade-up">
            ...
            {productTitle}
                <div className="col d-flex justify-content-center position-relative">
                    ...
                    <div className="position-absolute bottom-0"  style={{ "marginLeft":"30vh"}}>   
                        <button className="btn"><img src="/img/icon/Group 74.png" alt="like"/><p className="bg-danger text-white rounded-5 mt-1">{product.like_count}</p></button>
                    </div>
                    <div className="position-absolute bottom-0" style={{ "marginLeft":"50vh" }}>
                        <button className="btn"><img src="/img/icon/Group 73.png" alt="save"/><p className="bg-danger text-white rounded-5 mt-1">{product.save_count}</p></button>
                    </div>
                </div>
            ...
            <div className="col-lg">
                ...
                <iframe width="560" height="315" src={product.video_recipe} title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowFullScreen style={{ "width": "100%" }}></iframe>
                </div>
            </div>
            </div>
            <div className="row" style={{ "marginTop": "10vh" }}>
            <form action="">
                <div className="col-lg">
                    ...
                    <div className="d-flex justify-content-center m-2">
                        <button type="button" className="btn mb-3 p-2 rounded-2 text-white" style={{ "backgroundColor":"#EFC81A", "width": "350px", "fontSize":"10px", "height": "40px" }}>Send</button>
                    </div>    
                </div>
            </form>
            </div>
            ...
            <div className="modal fade" id="exampleModal" tabIndex="-1">
              <div className="modal-dialog">
                <div className="modal-content">
                  ...
                  <div>
                    <label className="mb-2" htmlFor="name">Title : </label>
                  ...
                  <div>
                    <label className="mb-2" htmlFor="name">Ingredients : </label>
                    <div className="input-group mb-3">
                        <input type="text" name="name" className="form-control"/>
                    </div>
                  </div>
                  ...
                  <div>
                    <label className="mb-2" htmlFor="name">Video : </label>
                    <div className="input-group mb-3">
                        <input type="text" name="name" className="form-control"/>
                    </div>
                  </div>
                    ...
                    <div>
                      <label className="mb-2" htmlFor="photo">Upload New Photo Product : </label>
                        <div className="input-group mb-3">
        ...
        <div className="row" style={{ "marginTop": "10vh" }}>
            ...
            <div className="col-lg-10 ms-4 mt-3">
                <div className=""><strong>Marcelle R</strong></div>
                <div><p>Nice Recipe. Simple And Delicious, Thankyou</p></div>
            </div>
